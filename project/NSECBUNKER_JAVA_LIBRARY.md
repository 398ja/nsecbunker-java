...
| Task ID | Task Description | Note | Size | Commit ID | Dependency | Status |
|---------|-----------------|------|------|-----------|------------|--------|
| 2.1.1 | Implement `NsecBunkerAdminClient` class | Main admin client with builder | M | | Phase 1 | ✅ DONE |
| 2.1.2 | Add admin connection setup | Generate ephemeral keypair for auth | S | | 2.1.1 | ✅ DONE |
| 2.1.3 | Implement admin request/response handling | Send kind 24134 messages | M | | 2.1.1, 1.4.* | ✅ DONE |
| 2.1.4 | Add admin authentication validation | Verify admin npub matches | S | | 2.1.3 | ✅ DONE |
